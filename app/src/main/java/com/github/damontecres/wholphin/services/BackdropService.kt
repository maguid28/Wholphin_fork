                ...
                val imageUrl =
                    if (item.type == BaseItemKind.GENRE) {
                        ...
                        imageUrlService.getItemImageUrl(
                            ...
                            fillWidth = FOCUSED_BACKDROP_MAX_WIDTH,
                            fillHeight = FOCUSED_BACKDROP_MAX_HEIGHT,
                        )
                    }
...
private const val FOCUSED_BACKDROP_MAX_WIDTH = 960
private const val FOCUSED_BACKDROP_MAX_HEIGHT = 540
