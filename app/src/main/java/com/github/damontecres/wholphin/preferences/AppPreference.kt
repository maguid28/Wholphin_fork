...
sealed interface AppPreference<Pref, T> {
    ...
    companion object {
        ...
        val CustomThemePrimary =
            AppChoicePreference<AppPreferences, Int>(
                title = R.string.custom_primary_colour,
                defaultValue = 0,
                getter = { it.interfacePreferences.customThemePrimary },
                setter = { prefs, value ->
                    prefs.updateInterfacePreferences {
                        customThemePrimary = value
                        appThemeColors = AppThemeColors.CUSTOM
                    }
                },
                displayValues = R.array.custom_theme_tones,
                indexToValue = { it },
                valueToIndex = { it },
            )

        val CustomThemeSecondary =
            AppChoicePreference<AppPreferences, Int>(
                title = R.string.custom_secondary_colour,
                defaultValue = 1,
                getter = {
                    if (it.interfacePreferences.customThemeSecondary == 0 &&
                        it.interfacePreferences.customThemeTertiary == 0
                    ) {
                        1
                    } else {
                        it.interfacePreferences.customThemeSecondary
                    }
                },
                setter = { prefs, value ->
                    prefs.updateInterfacePreferences {
                        customThemeSecondary = value
                        appThemeColors = AppThemeColors.CUSTOM
                    }
                },
                displayValues = R.array.custom_theme_tones,
        ...
        val CustomThemeTertiary =
            AppChoicePreference<AppPreferences, Int>(
                title = R.string.custom_tertiary_colour,
                defaultValue = 6,
                getter = {
                    if (it.interfacePreferences.customThemeSecondary == 0 &&
                        it.interfacePreferences.customThemeTertiary == 0
                        ...
                        it.interfacePreferences.customThemeTertiary
                    }
                },
                setter = { prefs, value ->
                    prefs.updateInterfacePreferences {
                        customThemeTertiary = value
                        appThemeColors = AppThemeColors.CUSTOM
                    }
                },
                displayValues = R.array.custom_theme_tones,
        ...
        val LibraryTabOrder =
            AppClickablePreference<AppPreferences>(
                title = R.string.library_tab_order,
        ...
        val LibraryTvEnabled =
            AppSwitchPreference<AppPreferences>(
                title = R.string.enable_library_tv,
                defaultValue = true,
                getter = { it.interfacePreferences.liveTvPreferences.enableLibraryTv },
                setter = { prefs, value ->
                    prefs.updateLiveTvPreferences { enableLibraryTv = value }
                },
                summary = R.string.enable_library_tv_summary,
                summaryOn = R.string.enabled,
                summaryOff = R.string.disabled,
            )
        val LibraryTvChannels =
            AppDestinationPreference<AppPreferences>(
                title = R.string.library_tv_channels,
                summary = R.string.library_tv_channels_summary,
    ...
    listOf(
        PreferenceGroup(
            ...
            conditionalPreferences =
                listOf(
                    ConditionalPreferences(
                        condition = { it.interfacePreferences.appThemeColors == AppThemeColors.CUSTOM },
                        preferences =
                            listOf(
