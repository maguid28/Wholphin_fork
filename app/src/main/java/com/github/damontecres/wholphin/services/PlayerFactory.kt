...
class PlayerFactory
    ...
    constructor(
            ...
            val newPlayer =
                when (backend) {
                    ...
                    -> {
                        ...
                        val trackSelector = createTrackSelector(audioOffloadEnabled = false)
        ...
        fun createAudioPlayer(extensions: MediaExtensionStatus = MediaExtensionStatus.MES_FALLBACK): ExoPlayer {
            ...
            val trackSelector = createTrackSelector(audioOffloadEnabled = true)
            return ExoPlayer
                .Builder(context)
                .setMediaSourceFactory(mediaSourceFactory)
                .setRenderersFactory(renderersFactory)
        ...
        private fun createTrackSelector(audioOffloadEnabled: Boolean) =
