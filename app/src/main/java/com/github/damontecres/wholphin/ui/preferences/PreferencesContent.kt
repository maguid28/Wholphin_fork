                            ...
                            when (pref) {
                                ...
                                AppPreference.ThemeColors -> {
                                    ThemeColorPreference(
                                        title = stringResource(pref.title),
                                        selectedTheme = preferences.interfacePreferences.appThemeColors,
                                        customThemeColorChoices = preferences.interfacePreferences.customThemeColorChoices(),
                                        onValueChange = { newTheme ->
                                            scope.launch(ExceptionHandler()) {
                                                preferences =
                                                    viewModel.preferenceDataStore.updateData { prefs ->
                                                        AppPreference.ThemeColors.setter(prefs, newTheme)
                                                    }
                                            }
                                        },
                                        modifier =
                                ...
                                -> {
                                    val tonePref = pref as AppPreference<AppPreferences, Int>
                                    CustomThemeTonePreference(
                                        title = stringResource(tonePref.title),
                                        selectedIndex = tonePref.getter.invoke(preferences),
                                        onValueChange = { newTone ->
                                            scope.launch(ExceptionHandler()) {
                                                preferences =
                                                    viewModel.preferenceDataStore.updateData { prefs ->
                                                        tonePref.setter(prefs, newTone)
                                                    }
                                            }
                                        },
                                        modifier =
