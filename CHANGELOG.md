...
- Fixed Movies and TV Shows recommended tabs so focus and scroll position restore to the row you left when returning from another section, using an in-memory focus cache that survives nav backstack changes.
